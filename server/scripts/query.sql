...
INSERT INTO query_item (category_id, query_id, title, url)
VALUES (NULL, 1, '집에서', ''),
       (NULL, 1, '운동할 때', ''),
       (NULL, 1, '여행지에서', ''),
       (NULL, 1, '학교에서', ''),
...
INSERT INTO query_category (id, query_id, title, url)
VALUES (1, 3, '아우터', ''),
       (2, 3, '탑', ''),
       (3, 3, '바텀', ''),
       (4, 3, '원피스', '')
...
INSERT INTO query (id, title, ui_type)
VALUES (4, '신체 중 드러내고 싶은 곳이 있다면 모두 선택해주세요. (선택사항)', 'U_LIST_BODY');

INSERT INTO query (id, title, ui_type)
VALUES (5, '신체 중 노출을 꺼리거나 가리고 싶은 곳이 있다면 모두 선택해주세요. (선택사항)', 'U_LIST_BODY');
...
VALUES (
           6,
           '웨어앳의 AI가 {{nickname}}님의 스타일을 정확히 파악할 수 있도록, 최근 사진 중 옷이 잘 보이는 사진으로 3장 이상을 올려주세요.(선택사항)',
