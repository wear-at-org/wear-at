    ...
    <div className="col-12 d-flex f-wrap mb64">
      <div className="col-12 col-sm-4 mb40 mb-sm-0 d-flex x-center card-wrap">
        <div className="card-section">
          <img src={mainIcon1} alt="mainIcon1" style={{ width: '287px', height: '327px' }} />
        </div>
      ...
      <div className="col-12 col-sm-4 mb40 mb-sm-0 d-flex x-center card-wrap">
        <div className="card-section">
          <img src={mainIcon2} alt="mainIcon1" style={{ width: '287px', height: '327px' }} />
        </div>
        <div className="detail-text">
          <h4>다양한 스타일 PICK!</h4>
          <h5>
      ...
      <div className="col-12 col-sm-4 mb40 mb-sm-0 d-flex x-center card-wrap">
        <div className="card-section">
          <img src={mainIcon3} alt="mainIcon1" style={{ width: '287px', height: '327px' }} />
        </div>
        <div className="detail-text">
          <h4>패션에 대한 모든 것</h4>
          <h5>
